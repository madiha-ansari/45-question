...
while (guestList.length > 2) {
    ...
    console.log("Sorry,".concat(removeGuest, "I cannt invite you to dinner"));
}
// sending a invitation to the last two guest on the last 
console.log("Invitation to the last 2 Guest");
guestList.forEach(function (lasttwo) { return console.log("Lucky ".concat(lasttwo, ", you are still invite to dinner")); });
